...
var ChangePasswordPage = function() {
  ...
  //MENU
  this.currentpassLabel = element(by.css('label[for="oldPassword"]'));
  this.newpassLabel = element(by.css('label[for="newPassword"]'));
  this.confirmnewpassLabel = element(by.css('label[for="confirmNewPassword"]'));
